...
public class CustomerController {
    ...
    @Operation(
            ...
            description = "Creates a new customer record with the provided details. Requires CASHIER, MANAGER, or ADMIN role."
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
            ...
            @ApiResponse(
                    responseCode = "400",
                    description = "Invalid input data - Email or phone may already exist or validation failed",
                    content = @Content
            ),
            @ApiResponse(
                    responseCode = "401",
    ...
    @Operation(
            ...
            description = "Updates specific fields of an existing customer identified by ID. Requires CASHIER, MANAGER, or ADMIN role."
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
            ...
            @ApiResponse(
                    responseCode = "400",
                    description = "Invalid input data or customer ID format",
                    content = @Content
            ),
            @ApiResponse(
                    responseCode = "401",
            ...
            @ApiResponse(
                    responseCode = "409",
                    description = "Email or phone already in use by another customer",
                    content = @Content
            ),
            @ApiResponse(
                    responseCode = "500",
    ...
    public ResponseEntity<CustomerDto> patchCustomer(
            ...
            @Parameter(
                    description = "Customer fields to update (only non-null fields will be updated)",
                    required = true,
    ...
    @Operation(
            ...
            description = "Deletes an existing customer identified by ID. Requires ADMIN role only."
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
            ...
            @ApiResponse(
                    responseCode = "409",
                    description = "Cannot delete customer with existing orders or transactions",
                    content = @Content
            ),
            @ApiResponse(
                    responseCode = "500",
    ...
    @Operation(
            ...
            description = "Retrieves detailed information of a specific customer by their ID"
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Searches for customers by name, email, phone, or other criteria"
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
