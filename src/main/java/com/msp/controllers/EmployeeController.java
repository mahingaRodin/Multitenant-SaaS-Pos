...
public class EmployeeController {
    ...
    @Operation(
            summary = "Create a store-level employee",
            description = "Creates a new employee assigned to a specific store. Requires ADMIN or STORE_MANAGER role."
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
                    description = "Store employee created successfully",
                    content = @Content(
            ...
            @ApiResponse(
                    responseCode = "400",
                    description = "Invalid input data - Email or username may already exist",
                    content = @Content
            ),
            @ApiResponse(
                    responseCode = "401",
    ...
    public ResponseEntity<UserDto> createStoreEmployee(
            @Parameter(
                    name = "storeId",
                    description = "UUID of the store where employee will work",
                    required = true,
    ...
    @Operation(
            summary = "Create a branch-level employee",
            description = "Creates a new employee assigned to a specific branch. Requires ADMIN, STORE_MANAGER, or BRANCH_MANAGER role."
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
                    description = "Branch employee created successfully",
                    content = @Content(
                            mediaType = "application/json",
                            schema = @Schema(implementation = UserDto.class)
                    )
    ...
    public ResponseEntity<UserDto> createBranchEmployee(
            @Parameter(
                    name = "branchId",
                    description = "UUID of the branch where employee will work",
                    required = true,
                    example = "123e4567-e89b-12d3-a456-426614174000"
            )
    ...
    @Operation(
            ...
            description = "Updates an existing employee's information. Requires ADMIN, STORE_MANAGER, or BRANCH_MANAGER role with appropriate scope."
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
            ...
            @ApiResponse(
                    responseCode = "400",
                    description = "Invalid input data or employee ID format",
                    content = @Content
            ),
            @ApiResponse(
                    responseCode = "401",
            ...
            @ApiResponse(
                    responseCode = "409",
                    description = "Email or username already in use by another employee",
                    content = @Content
            ),
            @ApiResponse(
                    responseCode = "500",
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(
                    responseCode = "409",
                    description = "Cannot delete employee with existing assignments or transactions",
                    content = @Content
            ),
            @ApiResponse(
                    responseCode = "500",
    ...
    @Operation(
            ...
            description = "Retrieves all employees for a specific store, optionally filtered by role"
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
    ...
    public ResponseEntity<List<UserDto>> storeEmployee(
            ...
            @Parameter(
                    name = "userRole",
                    description = "Filter employees by role (optional)",
                    example = "CASHIER",
    ...
    @Operation(
            ...
            description = "Retrieves all employees for a specific branch, optionally filtered by role"
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
                    description = "Branch employees retrieved successfully",
                    content = @Content(
                            mediaType = "application/json",
                            array = @ArraySchema(schema = @Schema(implementation = UserDto.class))
                    )
